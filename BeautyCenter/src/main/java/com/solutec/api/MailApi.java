...
public class MailApi {
	...
	public Mail mailCreationManager(@RequestBody User u){
		...
		String contenu = "Bonjour " + u.getPrenom() + " " + u.getNom() + "," 
		+ Newligne + Newligne + "Bienvenue sur BeautyCenter ! "
		+ Newligne + "l'administrateur de BeautyCenter vous a créé(e) un compte manager sur BeautyCenter."  
		+ Newligne + "Vous pourrez ainsi créer des salons, les gérer, leur associer des prestations ainsi que le personnel."
		+ Newligne + ""
		+ Newligne + "Vous trouverez ci-joint les identifiants pour vous connecter en tant que manager."
		+ Newligne + "mail :"+u.getMail() + " , "
		+ Newligne + "mot de passe : " + u.getMdp() + " ."
		+ Newligne + "Une fois connecté(e) nous vous invitons à aller sur votre espace manager, à changer votre mot de passe et à supprimer ce mail."
		+ Newligne + ""
